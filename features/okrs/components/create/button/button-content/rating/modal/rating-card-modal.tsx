...
import {
  ...
  getRaingRecordsResponsesAction,
  putHighScoreAction,
...
export default function RatingModalCard({
  objectiveId,
  keyResult,
  feedback,
  period,
  ...
  const handleSubmmitOKRClick = async () => {
    ...
    if (rating === "") {
      ...
      const newFb = feedbacks.find((x) => x.feedback?.id === feedback.id);
      setFb(newFb?.feedback!);
      const ratingRecords = unpackActionResponse(
        await getRaingRecordsResponsesAction(),
      );
      const s = ratingRecords.filter(
        (x) => x.okrPeriodId === newFb?.feedback?.okrPeriodByYearId,
      );
      setRatingRecordss(s);
    }
  };
              ...
              <div className="content">
                <div className="block" onClick={toggleExpand}>
                  ...
                  <div className="ml-2 flex">
                    ...
                    <div className="ml-0 mt-3 flex">
                      {fb !== null && fb.progressValue !== null && (
                        <label className="mb-2 ml-3 text-sm text-slate-500">
                          {"完成度: " + fb.progressValue + " %"}
                        </label>
                      )}
                    </div>
                        ...
                        <div className="w-6/12">
                          <div className="mb-3 mt-0 ">
                            ...
                            <textarea
                              ...
                              placeholder=""
                              disabled
                              value={fb !== null ? fb.progressDescription : ""}
                          ...
                          <div className="mb-3 ">
                            ...
                            <textarea
                              rows={6}
                              name="defectProblem"
                              value={fb !== null ? fb.defectProblem : ""}
                              disabled
                              className="h-20 w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                            ></textarea>
                          </div>
                          ...
                          <div className="mb-3">
                            ...
                            <textarea
                              ...
                              placeholder=""
                              disabled
                              value={fb !== null ? fb.requiredResources : ""}
                              className="h-20 w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                            ></textarea>
                          </div>
                        </div>
                        <div className="ml-10 mt-0 w-6/12">
                          <div className="mb-2">
                            ...
                            <textarea
                              ...
                              placeholder=""
                              disabled
                              value={fb !== null ? fb.nextPlanDescription : ""}
                              className="h-20 w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                            ></textarea>
                          </div>
                          <div className="mb-3">
