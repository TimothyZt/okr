...
export default function OBelongListBox({departments,values,setValues}:Props) {
  ...
  return (
    <ListboxWrapper>
      ...
      >
        {(item) => (
          <ListboxItem key={item.id} textValue={item.name} className=" border-b-2 border-stroke" >
